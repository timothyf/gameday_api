...
class TestGame < Test::Unit::TestCase
  ...
  def test_get_winner
    ...
    game = Gameday::Game.new('2009_09_20_nyamlb_seamlb_1')
    winner = game.get_winner
  ...
  def test_get_attendance
    ...
    game = Gameday::Game.new('2010_04_10_bosmlb_kcamlb_1')
    attend = game.get_attendance
  ...
  def test_get_innings
    ...
    game = Gameday::Game.new('2009_05_02_kcamlb_minmlb_1')
    innings = game.get_innings
  ...
  def test_get_num_innings
    game = Gameday::Game.new('2008_04_07_atlmlb_colmlb_1')
