...
class TestGamedayFetcher < Test::Unit::TestCase
  ...
  def test_fetch_gamedaysyn
    result = GamedayFetcher.fetch_gamedaysyn('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  end
  ...
  def test_fetch_linescore
    result = GamedayFetcher.fetch_linescore('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
  ...
  def test_fetch_miniscoreboard
    result = GamedayFetcher.fetch_miniscoreboard('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  end
  ...
  def test_fetch_players
    result = GamedayFetcher.fetch_players('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  end
  ...
  def test_fetch_plays
    result = GamedayFetcher.fetch_plays('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  end
  ...
  def test_fetch_scoreboard
    result = GamedayFetcher.fetch_scoreboard('2009', '9', '20')
    assert_not_nil result
    assert result.include?('<?xml version="1.0" encoding="UTF-8"?>')
  end
  ...
  def test_fetch_batter
    result = GamedayFetcher.fetch_batter('2009_09_20_detmlb_minmlb_1', '276346')
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  ...
  def test_fetch_pitcher
    result = GamedayFetcher.fetch_pitcher('2009_09_20_detmlb_minmlb_1', '150144')
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  ...
  def test_fetch_inningx
    result = GamedayFetcher.fetch_inningx('2009_09_20_detmlb_minmlb_1', 3)
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  ...
  def test_fetch_inning_scores
    result = GamedayFetcher.fetch_inning_scores('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  ...
  def test_fetch_inning_hit
    result = GamedayFetcher.fetch_inning_hit('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
    assert result.include?('Copyright 2009 MLB Advanced Media, L.P.  Use of any content on this page')
  ...
  def test_fetch_games_page
    result = GamedayFetcher.fetch_games_page('2009', '9', '20')
    assert_not_nil result
  ...
  def test_fetch_pitchers_page
    result = GamedayFetcher.fetch_pitchers_page('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
    assert result.include?('<h1>Index of /components/game/mlb/year_2009/month_09/day_20/')
  ...
  def test_fetch_gameday_connection
    result = GamedayFetcher.fetch_gameday_connection('2009', '9', '20')
    assert_not_nil result
  end
  
  
  def test_fetch_media_highlights
    result = GamedayFetcher.fetch_media_highlights('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
  ...
  def test_fetch_media_mobile
    result = GamedayFetcher.fetch_media_mobile('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
  ...
  def test_fetch_onbase_linescore
    result = GamedayFetcher.fetch_onbase_linescore('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
  ...
  def test_fetch_onbase_plays
    result = GamedayFetcher.fetch_onbase_plays('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
  ...
  def test_fetch_notifications_inning
    result = GamedayFetcher.fetch_notifications_inning('2009_09_20_detmlb_minmlb_1', 3)
    assert_not_nil result
  ...
  def test_fetch_notifications_full
    result = GamedayFetcher.fetch_notifications_full('2009_09_20_detmlb_minmlb_1')
    assert_not_nil result
